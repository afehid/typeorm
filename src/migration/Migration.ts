...
export class Migration {
    ...
    /**
     * SHA-256 checksum of the SQL generated by `up()` (64-char hex).
     * Undefined for rows created before this column existed, or when the
     * migration was recorded without an instance.
     */
    checksum?: string
